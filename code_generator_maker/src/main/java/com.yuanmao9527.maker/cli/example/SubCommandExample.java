package com.yuanmao9527.maker.cli.example;

import picocli.CommandLine;
import picocli.CommandLine.Command;

@Command(name = "com.yuanmao9527.maker/main", mixinStandardHelpOptions = true)
public class SubCommandExample implements Runnable {
    ...
    public static void main(String[] args) {
        ...
        // 查看主命令的帮助手册
//        String[] myArgs = new String[] { "--help" }; // 打印的是@Command内的内容
        // 执行增加命令
